...
$date-control-btn-width: $button-height; // from fsa-btn
$date-control-btn-height: $date-control-btn-width;
$date-control-btn-small-width: $button-height--sm; // from fsa-btn
...
$date-calendar-bg-color-selected: $color-fsa-secondary-900;
