      ...
      <div class="fsa-hide@l">
        <div class="fsa-alert fsa-alert--info fsa-alert--no-icon" role="alert">
          <div class="fsa-alert__body">
            <h3 class="fsa-alert__heading">See a scrollbar?</h3>
            <p class="fsa-alert__text fsa-text-size--2">While desktop-based browsers (e.g. Chrome, IE, etc) may show a big horizontal scrollbar, touch-based devices will render a much more subtle version of it. This is intentional.</p>
          </div>
        </div>
      </div>
    </div>
