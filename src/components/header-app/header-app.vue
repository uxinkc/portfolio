    ...
    <div class="fsa-header-app__bd">
      ...
      <div class="fsa-header-app__secondary">
        <span class="fsa-header-app__profile">
          <a class="fsa-header-app__profile-link" :href="PROFILE_URL">
            <img class="docs__primary-nav__icon" src="img/GitHub-Mark-Light-32px.png" alt=""> <span class="fsa-header-app__profile-name">{{ PROFILE_NAME }}</span>
          </a>
        </span>
      </div>
      -->
...
export default {
  ...
  computed: {
    appTitleValue(){
      return this.APP_ABBR_NAME + " Prototype Kit"
    },
  }
}
</script>